...
VariableMetadata variable_metadata[201] = {
  ...
  },
  {
    ...
    .list_properties = {0,0,experimental,experimental,experimental,experimental,0,experimental,experimental,0},
    .list_valid_names = {"threshold","static","stepped","real_error_capped","real_error_adaptative","constant_area","decreasing_area","complex_decreasing_area","template_area",0},
