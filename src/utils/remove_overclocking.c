...
Image * get_physical_image(Image * input,int binning, int side_band_size){
...
void remove_electronic_vertical_noise(Image * input,int binning){
...
void remove_electronic_horizontal_noise(Image * output,Image * input,int binning,int side_band_size){
...
void herringbone_removal1(Image * input){
