...
FIND_LIBRARY(FFTW3_FFTW_THREADS_LIBRARY
  NAMES fftw3_threads libfftw_threads libfftw3_threads libfftw3-3_threads
  PATHS 
  ${FFTW3_POSSIBLE_LIBRARY_PATH}
  )
...
FIND_LIBRARY(FFTW3_FFTWF_LIBRARY
  NAMES fftwf3 fftwf libfftwf libfftwf3 libfftw3f-3 fftw3f
  PATHS 
  ${FFTW3_POSSIBLE_LIBRARY_PATH}
  )

FIND_LIBRARY(FFTW3_FFTWF_THREADS_LIBRARY
  NAMES fftwf3_threads fftwf_threads libfftwf_threads libfftwf3_threads libfftw3f-3_threads fftw3f_threads
  PATHS 
  ${FFTW3_POSSIBLE_LIBRARY_PATH}
  )
...
FIND_LIBRARY(FFTW3_FFTWL_LIBRARY
  NAMES fftwl3 fftwl libfftwl libfftwl3 libfftw3l-3 fftw3l
  PATHS 
  ${FFTW3_POSSIBLE_LIBRARY_PATH}
  )

FIND_LIBRARY(FFTW3_FFTWL_THREADS_LIBRARY
  NAMES fftwl3_threads fftwl_threads libfftwl_threads libfftwl3_threads libfftw3l-3_threads fftw3l_threads
  PATHS 
  ${FFTW3_POSSIBLE_LIBRARY_PATH}
  )
...
LIST(APPEND FFTW3_LIBRARIES ${FFTW3_FFTWF_LIBRARY} ${FFTW3_FFTWF_THREADS_LIBRARY} ${FFTW3_FFTWL_LIBRARY} ${FFTW3_FFTWL_THREADS_LIBRARY} )
...
IF(FFTW3_LIBRARIES)
  IF (FFTW3_INCLUDE_DIR)
    ...
    GET_FILENAME_COMPONENT(FFTW3_LINK_DIRECTORIES ${FFTW3_FFTW_LIBRARY} PATH)
...
MARK_AS_ADVANCED(
  ...
  FFTW3_LIBRARIES
  FFTW3_FFTW_LIBRARY
  FFTW3_FFTW_THREADS_LIBRARY
  FFTW3_FFTW_SSE2_LIBRARY
  FFTW3_FFTWF_LIBRARY
  FFTW3_FFTWF_THREADS_LIBRARY
  FFTW3_FFTWF_SSE_LIBRARY
  FFTW3_FFTWL_LIBRARY
  FFTW3_FFTWL_THREADS_LIBRARY
  FFTW3_LINK_DIRECTORIES
)
